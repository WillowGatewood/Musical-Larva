...
export class WeightKnob extends LitElement {
  // Removed override as inheritance is not being recognized correctly in this environment
  static styles = css`
    :host {
      cursor: grab;
      position: relative;
  ...
  private handlePointerMove(e: PointerEvent) {
    ...
    // Cast this to any due to inheritance recognition errors
    (this as any).dispatchEvent(new CustomEvent<number>('input', { detail: this.value, bubbles: true, composed: true }));
  }
